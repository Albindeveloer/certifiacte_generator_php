				...
				<div class="carousel-inner" role="listbox">
					...
					<div class="item active" style="background-image: url(img/banner.jpeg);">
						<div class="carousel-caption">
							<h2 data-wow-duration="700ms" data-wow-delay="500ms" class="wow bounceInDown animated"><span>CERTIFICATE</span>!</h2>
							<h3 data-wow-duration="1000ms" class="wow slideInLeft animated"><span class="color">GENERATER</span></h3>
							<p data-wow-duration="1000ms" class="wow slideInRight animated">NIMIT</p>
					...
					<div class="item" style="background-image: url(img/banner.jpeg);">
						<div class="carousel-caption">
							<h2 data-wow-duration="500ms" data-wow-delay="500ms" class="wow bounceInDown animated"><span>CERTIFICATE</span>!</h2>
							<h3 data-wow-duration="500ms" class="wow slideInLeft animated"><span class="color">GENERATER</span></h3>
							<p data-wow-duration="500ms" class="wow slideInRight animated">NIMIT</p>
...
<div class="container">
<div class="row">
<div class="sec-title text-center mb50 wow
bounceInDown animated" data-wow-duration="500ms">
<h2>Features</h2>
